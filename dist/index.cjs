...
var import_type = require("@deepkit/type");
...
var ChatMessageInstance = class extends BaseInstance {
  constructor(data, client) {
    super((import_type.deserialize.\u03A9 = [[() => __\u03A9ChatMessageEvent, "n!"]], (0, import_type.deserialize)(data)), client);
  }
...
var import_cycletls = __toESM(require("cycletls"), 1);
var import_exit_hook = __toESM(require("exit-hook"), 1);
var import_tough_cookie = __toESM(require("tough-cookie"), 1);
...
var _ApiClient = class _ApiClient {
  constructor(client) {
    this.cookieJar = new import_tough_cookie.default.CookieJar();
    this.bearerToken = "";
    this._client = client;
    this._apiFetch = import_ofetch.ofetch.create({
      baseURL: "https://kick.com"
    });
  }
  async init() {
    this._cycleClient = await (0, import_cycletls.default)();
...
var import_type2 = require("@deepkit/type");
...
var AuthenticationEndpoint = class extends BaseEndpoint {
  async getTokens() {
    ...
    return import_type2.deserialize.\u03A9 = [[() => __\u03A9TokensResponse, "n!"]], (0, import_type2.deserialize)(response.body);
  }
  async login(credentials) {
    ...
    if (response.status === 422) {
      const responseBody = (import_type2.deserialize.\u03A9 = [[() => __\u03A9LoginErrorResponse, "n!"]], (0, import_type2.deserialize)(response.body));
    ...
    if (response.status === 200) {
      const responseBody = (import_type2.deserialize.\u03A9 = [[() => __\u03A9LoginResponse, "n!"]], (0, import_type2.deserialize)(response.body));
  ...
  async currentUser() {
    ...
    const deserializedBody = (import_type2.deserialize.\u03A9 = [[() => __\u03A9UserResponse, "n!"]], (0, import_type2.deserialize)(response.body));
    if (!deserializedBody.id) {
      throw new KientApiError({ name: "UNAUTHENTICATED" });
    }
    return import_type2.deserialize.\u03A9 = [[() => __\u03A9UserResponse, "n!"]], (0, import_type2.deserialize)(response.body);
  }
};
...
var import_type3 = require("@deepkit/type");
var __\u03A9GenericApiResponse = ["T", "error", "code", "message", "status", () => import_type3.__\u03A9Embedded, "data", `b!PP)4"'4#&4$M4%e"!o&"4'M`];
...
var import_type6 = require("@deepkit/type");
...
var import_type4 = require("@deepkit/type");
var ChannelInstance = class extends BaseInstance {
  constructor(data, client) {
    super((import_type4.deserialize.\u03A9 = [[() => __\u03A9GetChannelResponse, "n!"]], (0, import_type4.deserialize)(data)), client);
  }
  getChatroom() {
...
var import_type5 = require("@deepkit/type");
...
var LivestreamInstance = class extends BaseInstance {
  constructor(data, client) {
    super((import_type5.deserialize.\u03A9 = [[() => __\u03A9GetLivestreamResponse, "n!"]], (0, import_type5.deserialize)(data)), client);
  }
  getThumbnails() {
    ...
    return import_type5.deserialize.\u03A9 = [[() => __\u03A9LivestreamThumbnails, "n!"]], (0, import_type5.deserialize)(result);
  }
};
...
var ChannelEndpoint = class extends BaseEndpoint {
  ...
  async getLeaderboards(channel) {
    ...
    return import_type6.deserialize.\u03A9 = [['"']], (0, import_type6.deserialize)(response.body);
  }
  ...
  async getPoll(channel) {
    ...
    return import_type6.deserialize.\u03A9 = [[() => __\u03A9GetPollsResponse, "n!"]], (0, import_type6.deserialize)(response.body);
  }
};
...
var import_pusher_js = __toESM(require("pusher-js"), 1);
...
var WsClient = class {
  constructor(client) {
    ...
    this.pusher = new import_pusher_js.default(this.PUSHER_APP_KEY, pusherOptions);
...
var import_type7 = require("@deepkit/type");
var ChatEndpoint = class extends BaseEndpoint {
  async sendMessage(chatroomId, message) {
    ...
    const deserializedResponse = (import_type7.deserialize.\u03A9 = [[() => __\u03A9SendMessageResponse, "n!"]], (0, import_type7.deserialize)(response.body));
  ...
  async deleteMessage(chatroomId, messageId) {
    ...
    const deserializedResponse = (import_type7.deserialize.\u03A9 = [[() => __\u03A9GenericApiResponse, ',o!"']], (0, import_type7.deserialize)(response.body));
    if (deserializedResponse.status.code === 401) {
      throw new KientApiError({ name: "UNAUTHENTICATED" });
    }
    if (deserializedResponse.status.code !== 200) {
...
var _Kient = class _Kient extends import_strict_event_emitter.Emitter {
  constructor() {
    super(...arguments);
...
_Kient.__type = [() => __\u03A9KientEvents, () => import_strict_event_emitter.Emitter, () => ApiClient, "_apiClient", () => __\u03A9Endpoints, "_endpoints", () => WsClient, "_wsClient", () => ChatroomSocket, "chatroom", "_wsHandlers", "init", "create", () => __\u03A9KientEvents, `Pn!7"P7#3$;n%3&;P7'3(;PP7)4*M3+;P"0,;P"0-s!!5n.6"`];
var Kient = _Kient;
